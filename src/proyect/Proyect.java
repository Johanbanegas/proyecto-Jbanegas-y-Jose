...
public class Proyect {
    ...
    */
    ...
    public static void DatosdeAlumnos(int i) {    
           
    // FUNCION: datos generales del alumno
        ...
        System.out.println("ERROR.Debe estar entre 6 y 17 años.");
    }
...
sc.nextLine();
    ...
    public static void DatosAcademicos(int i) {  
// FUNCION: notas y promedio
 ...
 sc.nextLine();
    ...
    public static void MostrarResultados() {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            System.out.println("-----------Datos Academicos------------");
            System.out.println("La nota de Matematicas es :" + math[i]);
            System.out.println("La nota de Ingles es :" + ing[i]);
            System.out.println("La nota de Computacion es :" + comp[i]);
            System.out.println("La nota de Espanol es :" + esp[i]);
            System.out.println("La nota de Ciencias Sociales es :" + ccss[i]);
            System.out.println("La nota de Ciencias Naturales es :" + cn[i]);
            System.out.println("");
            System.out.println("------------------------------------");
            System.out.printf("el promedio es: %.2f ", promedio[i]);
